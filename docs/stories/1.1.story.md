...
- [x] **Task 3: Configure Clerk Authentication** (AC: 3)
  ...
  - [ ] Set up role claims in Clerk dashboard for Admin, Waiter, Kitchen, Cashier (requires dashboard access)
...
- [ ] **Task 7: Configure Vercel Deployment** (AC: 8)
  - [ ] Install Vercel CLI: `npm install -g vercel`
  - [ ] Run `vercel` command and link to project
  - [ ] Configure environment variables in Vercel dashboard
  - [ ] Set up automatic deployments from main branch
  - [ ] Configure preview deployments for pull requests
  - [ ] Verify build settings for Next.js 14
